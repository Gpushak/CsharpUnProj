...
class Program
{
    ...
    static void OneDimensionalMenu()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("2. Напечатать одномерный массив");
    ...
    static int[] CreateOneDimensionalArray()
    {
        ...
        {
            array[i] = rand.Next(1, 100); // Заполнение случайными числами
        }
    ...
    // Функция удаления всех нечетных элементов в одномерном массиве
    ...
    static void AddRowsToBeginning(ref int[,] array)
    {
        if (array == null || array.Length == 0)
        {
            Console.WriteLine("Массив пустой. Операция невозможа")
        }
        ...
        // Копирование оригинального массива после новых строк
        ...
        array = newArray;
        Console.WriteLine("Добавлено " + k + " строк в начало массива.");
    }
}
